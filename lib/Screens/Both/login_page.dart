             ...
             child: Stack(
               children: [
                ...
                Container(
                 ...
                 Container(
                   padding: EdgeInsets.fromLTRB(35.0, 130.0, 0.0, 0.0),
                   child: Text(
                     'Hustle',
                     style: TextStyle(
                         color: Colors.blueGrey.shade900,
                 ...
                 Container(
                   padding: EdgeInsets.fromLTRB(180.0, 125.0, 0.0, 0.0),
                   child: Text(
                     '.',
                     style: TextStyle(
                         fontSize: 60,
              ...
              child: Column(
                children: [
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: Container(
                                  ...
                                  child: InkWell(
                                      ...
                                      child: Icon(iconType,color: Color(0XFF6A62B7),)
                  ...
                  Row(
                    ...
                    children: [
                      Text("New to Beta Hustle?",style: TextStyle(
